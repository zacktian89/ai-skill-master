    ...
    <section class="list-panel">
      <div class="list-panel-head">
        <div class="list-search-row" style="display: grid; grid-template-columns: auto minmax(0, 1fr) 30px; gap: 8px; align-items: center;">
          <span class="search-row-count" style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 30px; font-family: ui-monospace, monospace; font-size: 12px; font-weight: 600; color: var(--text-secondary); background: var(--bg-input); border: 1px solid var(--border-default); border-radius: 6px; flex-shrink: 0;">{{ snapshot.state.agents?.length ?? 0 }}</span>
